...
export async function render(view) {
  ...
  btnBackup.addEventListener('click', () => api.backupDownload());
  ...
  try {
    ...
    engineNote.innerHTML =
      ...
      '本页是 <b>纯静态版</b>：网页文件放在 GitHub Pages 上，数据库直连 <b>Turso 云库</b>，' +
        '不需要任何服务器。所有打开该网址的人看到的是同一份数据。<br/>' +
        '想换数据库或查看分享链接：点右上角 <b>「云库连接」</b>。';
  } catch (e) {
